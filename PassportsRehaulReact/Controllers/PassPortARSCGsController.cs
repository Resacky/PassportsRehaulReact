...
namespace PassportsRehaulReact.Controllers
{
    ...
    public class PassPortARSCGsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<PassPortARSCG>>> GetPassPortARSCGs()
        {
          if (_context.PassPortARSCGs == null)
          {
              return NotFound();
          }
            return await _context.PassPortARSCGs.ToListAsync();
        }
        ...
        public async Task<ActionResult<PassPortARSCG>> GetPassPortARSCG(int id)
        {
          if (_context.PassPortARSCGs == null)
          {
            ...
            var passPortARSCG = await _context.PassPortARSCGs.FindAsync(id);
        ...
        public async Task<ActionResult<PassPortARSCG>> PostPassPortARSCG(PassPortARSCG passPortARSCG)
        {
          if (_context.PassPortARSCGs == null)
          {
              return Problem("Entity set 'PassportDbContext.PassPortARSCGs'  is null.");
          }
            _context.PassPortARSCGs.Add(passPortARSCG);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeletePassPortARSCG(int id)
        {
            ...
            _context.PassPortARSCGs.Remove(passPortARSCG);
            await _context.SaveChangesAsync();
        ...
        {
            return (_context.PassPortARSCGs?.Any(e => e.PPARSIDCG == id)).GetValueOrDefault();
        }
    }
}
